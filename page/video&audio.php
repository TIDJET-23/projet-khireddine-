...
if (isset($_POST["btnsupp"])) {
    $supp=supprimervidaud();
	header("Location: video&audio.php");

}
if (isset($_POST["btnmodifie"])) {
    $modifie=modifievidaud();
...
<?php foreach($affichevidaud as $afva): ?> 
    ...
    <div class="col-lg-12 mx-auto">
        ...
        <div class="position-relative border-radius-xl overflow-hidden shadow-lg mb-7">
			<div class="container border-bottom">
				<div class="row justify-space-between py-2">
					...
					<div class="" style="float: right;">
                        ...
                        <button type="button" name="btnmod" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#element<?= $afva->id?>" style="float: right;"><svg xmlns="http://www.w3.org/2000/svg" width="15" height="15" fill="currentColor" class="bi bi-pencil-fill" viewBox="0 0 16 16">
					...
					<div class="col-lg-2">
						<div class="nav-wrapper position-relative end-0">
							<ul class="nav nav-pills nav-fill flex-row p-1" role="tablist">
								<li class="nav-item">
								<a class="nav-link mb-0 px-0 py-1 active" data-bs-toggle="tab" href="#preview<?= $afva->id?>" role="tab" aria-selected="true">
									Preview
								</a>
								</li>
								<li class="nav-item">
								<a class="nav-link mb-0 px-0 py-1" data-bs-toggle="tab" href="#code<?= $afva->id?>" role="tab" aria-selected="false">
									 Code
								</a>
								</li>
							</ul>
            ...
            <div class="tab-content tab-space">
                <div class="tab-pane active" id="preview<?= $afva->id?>">
						...
						<div class="container">
							...
							<div class="col-12 mx-auto">
								<!--code-->
							<?= $afva->vidaud?>
							<input type="password" name="idvidaud" hidden value="<?= $afva->id?>">
            ...
            <div class="tab-pane" id="code<?= $afva->id?>">
                <div class="position-relative p-4 pb-2">
				    <!--text-->    
                    <textarea name="" id=""  style="border: none;width: 100%; height: 300px;" disabled="disabled"><?= $afva->vidaud?></textarea>
				</div>
							...
							<div class="modal fade" id="element<?= $afva->id?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
								<div class="modal-dialog">
									...
									<div class="modal-body">
										<!--code-->
										<textarea name="codemodifie" id=""  style="border: none;width: 100%; height: 300px;"><?= $afva->imag?></textarea>
